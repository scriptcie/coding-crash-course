...
const DemoSlides = [
  ...
  <Slide transitionEffect="slide">
      ...
      {(value, step) => (
        <Box position="relative">
          ...
          >
            ...
            {step === 2 && (
              <Text fontSize="1.5rem" margin="0rem">
                You can use the stepper state to render whatever you like as you
    ...
    <Text>
      Code Blocks now auto size and scroll when there is an overflow of content!
      They also auto-wrap longer lines.
    </Text>
  </Slide>,
  <Slide>
